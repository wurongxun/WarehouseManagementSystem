...
/**
 * @Description OutOfStockInformationExcel
 * @Author Rongxun.Wu
 * @Date 2020/4/19 17:08
 * @Version 1.0
 */
public class OutOfStockInformationExcel {

    public XSSFWorkbook CreateOutOfStockInformationListExcel(List<DetailedListInformation> listresult) {
        // 1.创建HSSFWorkbook，一个HSSFWorkbook对应一个Excel文件
        XSSFWorkbook wb = new XSSFWorkbook();
        // 2.在workbook中添加一个sheet,对应Excel文件中的工作表
        XSSFSheet sheet = wb.createSheet("sheet1");
        // 3.设置表头，即每个列的列名
        String[] titel = {"出库单编号", "申请时间", "申请出库人", "审批人","审批时间",
                "出库单名称", "出库时间", "收货人名", "收货人电话",
                "收货人地址", "总金额/元", "数量", "状态", "是否已出库",};
        // 3.1创建第一行
